...
public class Settings extends ActionBarActivity {
    ...
    public void conectar2() {
        ...
        try {
            ...
            // String url = "jdbc:mysql://" + "10.0.2.2:3306" + "/" + "qbtiempo";
            String url = "jdbc:mysql://10.0.2.2:3306/qbtiempo";
            // Se obtiene una conexi󮠣on la base de datos.
            connMySQL = DriverManager.getConnection(url, "root", "abc");
            ...
            public void run() {
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        //      db = openOrCreateDatabase("DB_QBTIEMPOS.sqlite", Context.MODE_PRIVATE, null);
