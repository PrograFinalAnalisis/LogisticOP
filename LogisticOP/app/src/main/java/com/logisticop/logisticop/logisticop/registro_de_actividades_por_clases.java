...
public class registro_de_actividades_por_clases extends ActionBarActivity {
    ...
    String id_horas;
    Boolean Insertado;
    String id_minutos, Customer_FullName, ItemService_FullName, Class_FullName, PayrollItemWage_FullName, Entity_FullName;
    ...
    public class MyOnItemSelectedListener implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
            ...
            //si selecciona el spinner clientes obtendra los valores id_clientes y Customer_FullName de la clase
            //igual con los otros spinners segun se la actividad selecciona
    ...
    public void Grupo() {
        // este metodo grpo carga a las personas  o empleado asignados a un clase
        // es decir si jose esta asignado a la clase bodegas entonces al seleccionar la clase bodegas
        //cargara a jose
        try {
            ...
            //ejecuto un join y busco a los empleado asignados a la clase seleccionada
            ...
            //creo un LinkedList de la clase ListEmpleados
            //y declaro un objecto
            while (c.moveToNext()) {
                //asigno los valores obtenidos del cursor
                //y los agrego a la clase ListEmpleados
            ...
            Lv_Empleados.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    ListEmpleados ids;
                    int pos = -1, j = 0;
                    //obtengo la posicion que selecciono en el listview
                    tmpseleccionar = (String) Lv_Empleados.getItemAtPosition(position).toString();
                    ids = (ListEmpleados) Lv_Empleados.getItemAtPosition(position);//busco la posicion  en la clase
                    //  ids.getId();
    ...
    public void cargarActividad() {
        try {
            ...
            //recorro el cursor y lo agrego a la clase actividad
    ...
    public void cargarNomina() {
        try {
            ...
            //recorro el cursor y lo agrego a la clase nomina
    ...
    public void cargarClientes() {
        ...
        try {
            ...
            //recorro el cursor y lo agrego a la clase Cliente
    ...
    public void cargarHoraS() {
        ...
        try {
            ...
            //recorro el cursor y lo agrego a la clase Horas
            while (filas.moveToNext()) {
    ...
    public void cargarMinutos() {
        ...
        try {
            ...
            //recorro el cursor y lo agrego a la clase Minutos
            while (filas.moveToNext()) {
    ...
    public void cargarGrupo() {
        //este carga el spinner de grupo
        try {
            db = openDatabase(DB_PATH + DB_NAME, null, SQLiteDatabase.CREATE_IF_NECESSARY);
            //habro la conexion a la base y ejeecuto un select
            Cursor filasDep = db.rawQuery("select _id, FullName from  clases", null);
    ...
    public void BtnGrupo(View v) throws ParseException {
        ...
        * */
        ...
        NuevafechaFin.set(pYear2, (pMonth2 + 1), (pDay2 + 1));
        ...
        for (int m = 0; m < CantidadDias; m++) {
            ...
            String fechaFinal = pYear2 + "-" + (pMonth2 + 1) + "-" + (pDay2 + 1);
            //String fechaFinal = (pMonth2 + 1) + "/" + (pDay2 + 1) + "/" + pYear2;
            //al mes se le suma uno por que la variable esta en 0 y al dia sele suma uno para cuando se hace el if  salga
            ...
            if (sCadenaSinBlancos.equals(fechaf)) {
                //  textView8.setText("insertado  1");
                //  Toast toast1 =
                //            Toast.makeText(getApplicationContext(),
                //                   "Actividades Registradas con exito  1", Toast.LENGTH_SHORT);
//
                //     toast1.show();
                ...
                for (i = 0; i < ListNombres_Seleccionados.size(); i++) {
                    ...
                    //----------------------inserta las actividades a sqlite
            ...
            if (cont == CantidadDias || Insertado == true) {
                //  textView8.setText("Actividades Registradas con exito");

                Toast toast1 =
                        Toast.makeText(getApplicationContext(),
                                "Actividades Registradas con exito", Toast.LENGTH_SHORT);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            ...
            broadcastIntent.setAction("com.logisticop.logisticop.logisticop.ACTION_LOGOUT");
